...
# geo_sets = ['coords', 'p1001', 'p1002', 'p1003', 'p2001', 'p2002', 'p2003']
geo_sets = ['coords']

f = open('AmanitaStart.txt', 'r') 
...
posCoordCol = 5 #position of column of the coordinates, or in the many iterations version the first column with the coordinates
